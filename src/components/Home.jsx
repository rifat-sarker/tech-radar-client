      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        ...
        <div className="card max-h-96 bg-base-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <small className="font-semibold">Discover the innovative world of Apple</small>
          </div>
        </div>
        {/* Huawei */}
        <div className="card max-h-96 bg-base-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <small className="font-semibold">Huawei is a leading global provider of information and communications technology (ICT)</small>
          </div>
        </div>
        {/* Samsung */}
        <div className="card max-h-96 bg-base-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <small className="font-semibold ">Discover the latest in electronic & smart appliance technology with Samsung</small>
          </div>
        </div>
        {/* Nokia */}
        <div className="card max-h-96 bg-base-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <small className="font-semibold">At Nokia, we create technology that helps the world act together</small>
          </div>
        </div>
        {/* Sony */}
        <div className="card max-h-96 bg-base-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <small className="font-semibold">At Sony, we believe in the power of creativity and technology. </small>
          </div>
        </div>
        {/* Google */}
        <div className="card max-h-96 bg-base-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <small className="font-semibold">Discover stories about our culture, philosophy, and how Google technology is impacting others.</small>
          </div>
        </div>
      </div>
      {/* footer */}
